    ...
    <div class="promocodes__row">
      <div class="promocodes__column">
        <div class="promocodes__items promocodes__items_page">
          <div
            class="promocodes__item promocodes__item_page <?php echo $is_expired ? 'filter-grayscale' : ''; ?>"
            ...
            <div class="promocodes__wrapper promocodes__wrapper_page">
              ...
              <div class="promocodes__data promocodes__data_page">
                ...
                <?php elseif ($has_coupon_code) : ?>
                  <button class="btn-reset promocodes__view promocodes__button" data-post-id="<?php echo esc_attr((string) get_the_ID()); ?>">Применить код</button>
                <?php else : ?>

...
$expired_actions_enabled = ! class_exists( 'Promokodiki_Filter_Settings' ) || ! empty( Promokodiki_Filter_Settings::get()['expired_actions_enabled'] );
...
<div class="promocodes__item <?php echo $is_expired ? 'filter-grayscale' : ''; ?>" data-post-id="<?php echo get_the_ID(); ?>">
    ...
    <div class="promocodes__wrapper">
        ...
        <div class="promocodes__data">
            ...
            <?php if ( $is_expired && ! $expired_actions_enabled ) : ?>
                <button class="btn-reset promocodes__button" disabled>Истекло</button>

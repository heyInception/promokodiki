...
wp_update_nav_menu_item( $menu_id, 0, array( 'menu-item-title' => 'Тестовый магазин', 'menu-item-url' => home_url( '/?taxonomy=shops_category&term=test-shop' ), 'menu-item-status' => 'publish' ) );

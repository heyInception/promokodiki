...
foreach ( $wpdiscuz_addons as $key => $addon) {
    update_option( 'gvt_product_' . $addon . '_redpoint', '0' );
    update_option( 'gvt_product_secret_' . $addon, 'secret' );
    delete_option( '_gvt_product_gvtUpdateMsg_' . $addon );
}

...
- Импорт автоматически разбивается на запросы не более 20 предложений и примерно 4 МБ; если одно изображение само превышает лимит запроса, предложение импортируется без изображения.
